...
window = sg.Window('PyNote', layout=layout, margins=(0, 0), resizable=True, return_keyboard_events=True, finalize=True)
window.maximize()
...
def save_file_as():
    '''Save new file or existing file with new name'''
...
def about_me():
    sg.popup_no_wait('"I have not failed. I\'ve just found 10,000 ways that won\'t work." - Thomas A. Edison')
